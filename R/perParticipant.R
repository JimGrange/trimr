#------------------------------------------------------------------------------
#' Per Participant SD RT trimming
#'
#' \code{perParticipant} takes a data frame of RT data and returns trimmed rt
#' data that fall below a set standard deviation above the each participant's
#' mean (e.g., trimming all RTs slower than 2SDs of each participant's
#' overall mean; i.e., ignoring condition).
#'
