#------------------------------------------------------------------------------
#' Per Cell Per Participant SD RT trimming
#'
#' \code{perCellParticipant} takes a data frame of RT data and returns trimmed rt
...
#' trimmedData <- perCellParticipant(data = exampleData, minRT = 150, sd = 2.5,
#' returnType = "mean")
#'
#'
#' @export
