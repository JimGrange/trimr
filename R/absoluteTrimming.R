###
# absolute trimming methods


#------------------------------------------------------------------------------
#' Absolute RT trimming
#'
#' \code{absoluteRT} takes a data frame of RT data and returns trimmed means.
#'
...
#'
#' @param rawdata A data frame. It must contain columns named "participant",
...
#' To do
#' @export
absoluteRT <- function(rawdata, minRT, maxRT, omiterrors = TRUE,
